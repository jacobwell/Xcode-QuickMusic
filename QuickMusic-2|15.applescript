	...
	if name of theObject is "exit" then
		...
		if content of text field "triob" of window "thewindow" is "1" then
			...
			if content of text field "toggler" of window "thewindow" is "0" then
				...
				set bounds of window "thewindow" to {disp_x2 - 217, disp_y2 - 44, disp_x2 - 0, disp_y2 - 20}
				repeat with theV from 44 to 67 by 2
					set bounds of window "thewindow" to {disp_x2 - 217, disp_y2 - theV, disp_x2 - 0, disp_y2 - 20}
				end repeat
				...
				set bounds of window "thewindow" to {disp_x2 - 217, disp_y2 - 67, disp_x2 - 0, disp_y2 - 20}
				repeat with theX from 67 to 44 by -2
					set bounds of window "thewindow" to {disp_x2 - 217, disp_y2 - theX, disp_x2 - 0, disp_y2 - 20}
				end repeat
			end if
		end if
